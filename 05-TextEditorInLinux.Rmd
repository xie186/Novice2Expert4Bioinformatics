...
Here I showed the details of three modes in Table \@ref(tab:textEditorLinuxVi3modes)

(ref:textEditorLinuxVi3modes) Details of three modes of vi.

```{r textEditorLinuxVi3modes, echo=FALSE}
tab<-read.csv("tables/textEditorLinuxVi3modes.csv", fileEncoding="UCS-2LE")
knitr::kable(tab, caption = '(ref:textEditorLinuxVi3modes)', booktabs = TRUE)
```
